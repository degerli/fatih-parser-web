...
<s:layout-render name="/WEB-INF/jsp/common/layout_main.jsp" title="Fatih Parser Turkmence" parse_turkmen="selected">
    <s:layout-component name="body">
    Elimizde Türkmence için morfolojik kelime çözümleyicisi bulunmadığından <a href="TurkmenWords.action">sınırlı sayıda kelimeyi</a> el ile çözümlemek durumunda kaldık. Sistem bu kelimelerle kurulmuş cümleleri analiz edebilmektedir.
        <s:form beanclass="fatihparser.action.ParseAction">
            <table class="formtable">
                ...
                <s:checkbox name="debugMode" ></s:checkbox>
                    ...
                    <tr><td><s:submit name="parseTurkmen" value="Çözümle" class="button"/> </td>
                </tr>
            </table>
        </s:form>
